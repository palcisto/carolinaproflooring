...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
	  // Selectors
	  var $hardwoodCallout = $('#hardwood-callout');
	  var $buffCallout = $('#buff-callout');
	  var $sandingCallout = $('#sanding-callout');
	  var $gallery = $('.gallery');
	
	  // Private methods
	  function calloutClickHandlerCreator(name) {
	    return function calloutClickHandler() {
	      var $callouts = [{
	      ...
	      $('#' + $currentCallout.name).removeClass('service--is-active');
	      $selectedCallout.button.addClass('service-callout--is-active');
	      $('#' + $selectedCallout.name).addClass('service--is-active');
	
	      var $target = '#' + $selectedCallout.name;
	      $('html,body').animate({
	  ...
	  var hardwoodCalloutClickHandler = calloutClickHandlerCreator('hardwood-service');
	  var buffCalloutClickHandler = calloutClickHandlerCreator('buff-coat-service');
	  var sandingCalloutClickHandler = calloutClickHandlerCreator('sanding-service');
	  ...
	  //     if (destination === 'buff-coat-serice' || destination === 'sanding-service') {
	  //       calloutClickHandlerCreator(destination);
	  //     }
	  ...
	  // Initialize slick slider on gallery
	  $gallery.slick();
	  ...
	  // Event listeners
	  $hardwoodCallout.on('click', hardwoodCalloutClickHandler);
